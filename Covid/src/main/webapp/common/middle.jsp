            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li class="hidden-xs"><a href="./cart1.jsp">My Cart</a></li>
                  <li class="hidden-xs"><a href="./check.jsp">Checkout</a></li>
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse in" aria-expanded="true" style="">
            <ul class="nav navbar-nav" data-smartmenus-id="16491485551964553">
              ...
              <li class=""><a href="./prod.jsp" class="has-submenu" id="sm-16484886160634744-1" aria-haspopup="true" aria-controls="sm-16484886160634744-2" aria-expanded="false">Product Category<span class="caret"></span></a>
                <ul class="dropdown-menu" id="sm-16484886160634744-2" role="group" aria-hidden="true" aria-labelledby="sm-16484886160634744-1" aria-expanded="false" style="width: auto; display: none;">                
                  <li><a href="./prod.jsp">Mask</a></li>
                  <li><a href="./prod.jsp">Sanitizer</a></li>
                  <li><a href="./prod.jsp">Thermometer</a></li>
                  <li><a href="./prod.jsp">PPE kit</a></li>                                                
                  <!-- <li><a href="./product.jsp">Anti-Fogg type</a></li> -->
                  <li><a href="./prod.jsp">Oximeter</a></li>
