...
<%
	...
	try{
		...
		if(z==1)
		{
			...
			response.sendRedirect("prod.jsp?msg=exist");
			
		}
		if(z==0)
		{
			PreparedStatement ps=con.prepareStatement("insert into cart(email,product_id,quantity,price,total) values(null,?,?,?,?)");
			...
			ps.executeUpdate();
			response.sendRedirect("prod.jsp?msg=added");
	...
	catch(Exception e)
	{
		...
		response.sendRedirect("prod.jsp?msg=invalid");
	}
