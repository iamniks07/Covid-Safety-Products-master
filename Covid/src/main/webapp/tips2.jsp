...
<%@include file="./common/middle1.jsp" %>
  ...
  <section id="aa-catg-head-banner"> 
    ...
    <div class="aa-catg-head-banner-area">
      <div class="container">
       <div class="aa-catg-head-banner-content">
         <h2>Covid Preventive Tips</h2>
         <ol class="breadcrumb">
           <li><a href="./homepage.jsp">Home</a></li>         
           <li class="active">Covid Preventive Tips</li>
         </ol>
       </div>
      </div>
    </div>
   ...
   <p>
   <h1 align="center">Tips for prevention</h1>
    ...
    <p>Use warm water and soap and rub your hands for at least 20 seconds. Work the lather to your wrists, between your fingers, and under your fingernails. You can also use an antibacterial and antiviral soap.
    
    Use hand sanitizer when you cannot wash your hands properly. Rewash your hands several times a day, especially after touching anything, including your phone or laptop.</p>
    
   <h3> 2. Avoid touching your face</h3>
    <p>SARS-CoV-2 can live on some surfaces for up to 72 hours. You can get the virus on your hands if you touch a surface like:
   ...
   <h3> 3. Stop shaking hands and hugging people for now</h3>
    <p>Similarly, avoid touching other people. Skin-to-skin contact can transmit SARS-CoV-2 from one person to another.</p>
   ...
   <p> Do not share personal items like:
    ...
    makeup
    combs
    It’s also important not to share eating utensils and straws. Teach children to recognize their reusable cup, straw, and other dishes for their own use only.</p>
   ...
   <h3> 5. Cover your mouth and nose when you cough and sneeze</h3>
    ...
    Use a tissue or sneeze into your elbow to keep your hands as clean as possible. Wash your hands carefully after you sneeze or cough, regardless.</p>
  ...
  <h3>  7. Take physical (social) distancing seriously</h3>
    ...
    If you must go out for necessities, keep a distance of 6 feet (2 m) from other people. You can transmit the virus by speaking to someone in close contact to you.</p>
   ...
   <p> Being in a group or gathering makes it more likely that you’ll be in close contact with someone.
    ...
    This includes avoiding all religious places of worship, as you may have to sit or stand too close to another congregant. It also includes not congregating at parks or beaches.</p>
  ...
  <p>  Now is not the time to go out to eat. This means avoiding restaurants, coffee shops, bars, and other eateries.
    ...
    The virus can be transmitted through       </p>
</p>
