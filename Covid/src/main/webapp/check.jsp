                ...
                <div class="checkout-left">
                  <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default aa-checkout-coupon">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="./checkout.jspcollapseOne">
                            Have a Coupon?
                          </a>
                        </h4>
                      </div>
                    ...
                    <div class="panel panel-default aa-checkout-login">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="./checkout.jspcollapseTwo">
                            Client Login 
                          </a>
                        </h4>
                      </div>
                      <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                          ...
                          <p class="aa-lost-password"><a href="./checkout.jsp">Lost your password?</a></p>
                        </div>
                      </div>
                    </div>
                    <!-- Billing Details -->
                    <div class="panel panel-default aa-checkout-billaddress">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="./checkout.jspcollapseThree">
                            Billing Details
                          </a>
                        </h4>
                      </div>
                    ...
                    <div class="panel panel-default aa-checkout-billaddress">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a data-toggle="collapse" data-parent="#accordion" href="./checkout.htmlcollapseFour">
                            Shippping Address
                          </a>
                        </h4>
                      </div>
                ...
                <div class="checkout-right">
                  ...
                  <div class="aa-order-summary-area">
                    <table class="table table-responsive">
                      ...
                      <tbody>
                        <tr>
                          <td>mask<strong> x  1</strong></td>
                          <td>rs,30</td>
                        </tr>
                        <tr>
                          <td>sanitizer<strong> x  1</strong></td>
                          <td>rs.50</td>
                        </tr>
                        <tr>
                          <td>thermometer<strong> x  1</strong></td>
                          <td>rs.300</td>
                        </tr>
                      </tbody>
                      <tfoot>
