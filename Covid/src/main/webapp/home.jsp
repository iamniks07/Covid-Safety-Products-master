                ...
                <div class="aa-promo-right">
                  <div class="aa-f-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="./prod.jsp">SANITIZER</a></h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-f-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="./prod.jsp">PPE KIT</a></h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-s-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="./prod.jsp">THERMOMETER</a></h4>                        
                      </div>
                    </div>
                  </div>
                  <div class="aa-s-promo-right">
                    <div class="aa-promo-banner">                      
                      ...
                      <div class="aa-prom-content">
                        <h4><a href="./prod.jsp">OXIMETER</a></h4>                        
                      </div>
                    </div>
                  </div>
                </div>
